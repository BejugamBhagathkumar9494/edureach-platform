...
export const getRAGResponse = async (question: string, history: any[] = []): Promise<string> => {
  try {
    ...
    const agent = createAgent({
      ...
      systemPrompt:
        ...
        "Be concise, friendly, and professional. Use markdown formatting (like bolding, lists, etc.) to present structured information when appropriate. " +
